...
extern Uint16 ChgTempCompensation(Uint16 u16ChgBattTemp);
extern Uint16 EventLogQueueOut(void);
extern void DisableDog_Boot(void);
extern void InitFlash_Bank0_Boot(void);
extern void UpDatePos(Uint16 u16PosVoltRef, Uint16 u16Offset);
