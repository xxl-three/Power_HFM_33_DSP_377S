...
void InitSysCtrl(void)
{
   ...
   // GPIO_EnableUnbondedIOPullups();
    ...
    //InitSysPll(XTAL_OSC, IMULT_40, FMULT_0, PLLCLK_BY_2); //10M OSC
    InitSysPll(XTAL_OSC,IMULT_20,FMULT_0,PLLCLK_BY_2);    //20M OSC
    //InitSysPll(XTAL_OSC,IMULT_16,FMULT_0,PLLCLK_BY_2);    //25M OSC
    //InitSysPll(INT_OSC2,IMULT_38,FMULT_0,PLLCLK_BY_2);    //10M OSC
